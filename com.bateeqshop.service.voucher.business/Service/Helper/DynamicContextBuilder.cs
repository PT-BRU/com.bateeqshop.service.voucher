...
namespace com.bateeqshop.service.voucher.business.Service.Helper
{
    public static class DynamicContextBuilder
    {
        ...
        private static Type[] GetTypesToAdd()
        {
            ...
            var listOfTypes =
                ...
                where typeof(StandardEntity).IsAssignableFrom(assemblyType) && assemblyType != typeof(StandardEntity)
                select assemblyType;
